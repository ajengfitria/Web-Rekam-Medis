    ...
    <div class="row">
      <div class="col-8">
        ...
        <div class="card card-info">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form method="post" action="{{ route('obat.store')}}" class="form-horizontal">
            @csrf
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" name="kategori" class="form-control" id="inputName" placeholder="Kategori" value="{{ old('kategori') }}">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputName" class="col-sm-2 col-form-label">Stok</label>
                <div class="col-sm-10">
                  <input type="text" name="stok" class="form-control" id="inputName" placeholder="Stok" value="{{ old('stok') }}">
                </div>
              </div>
            </div>
            <!-- /.card-body -->
