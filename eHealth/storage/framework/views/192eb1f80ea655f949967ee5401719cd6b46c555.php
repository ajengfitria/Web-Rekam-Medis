    ...
    <div class="row">
      <div class="col-8">
        ...
        <div class="card card-info">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form method="post" action="<?php echo e(route('pasien.update',['id' => $pasien->id])); ?>" class="form-horizontal">
          ...
          <?php echo csrf_field(); ?>
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input required type="number" name="nik" class="form-control" placeholder="NIK" value="<?php echo e($pasien->nik); ?>">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputName" class="col-sm-2 col-form-label">Nama</label>
                <div class="col-sm-10">
                  <input required type="text" name="nama" class="form-control" placeholder="Nama" value="<?php echo e($pasien->nama); ?>">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="jenkel" required>
                    ...
                    <option value="<?php echo e($jk); ?>" <?php echo e(($pasien->jenkel == $jk) ? 'selected' : ''); ?>><?php echo e($jk); ?></option>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input required type="date" name="tgl_lahir" class="form-control" placeholder="Tanggal Lahir" value="<?php echo e($pasien->tgl_lahir); ?>">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input required type="number" name="telp" class="form-control" placeholder="Telp" value="<?php echo e($pasien->telp); ?>">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPekerjaan3" class="col-sm-2 col-form-label">Pekerjaan</label>
                <div class="col-sm-10">
                  <input required type="text" name="pekerjaan" class="form-control" id="inputPekerjaan3" placeholder="Pekerjaan" value="<?php echo e($pasien->pekerjaan); ?>">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="id_kartu" required>
                    ...
                    <option value="<?php echo e($rl->id); ?>" <?php echo e(($pasien->id == $rl->id) ? 'selected' : ''); ?>><?php echo e($rl->nama); ?> - Kelas <?php echo e($rl->kelas); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input required type="number" name="no_kartu" class="form-control" placeholder="Nomor Kartu" value="<?php echo e($pasien->no_kartu); ?>">
                </div>
              </div>
            </div>
            <!-- /.card-body -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rekam-medis\Web-Rekam-Medis\eHealth\resources\views/pasienEdit.blade.php ENDPATH**/ ?>