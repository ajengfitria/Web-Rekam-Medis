...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="form-group row">
                <label for="inputName" class="col-sm-2 col-form-label">Spasialis</label>
                <div class="col-sm-10">
                  <input required type="number" name="spesialis" class="form-control" placeholder="Spasialis" value="<?php echo e($dokter->spesialis); ?>">
                </div>
              </div>
              <div class="form-group row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rekam-medis\Web-Rekam-Medis\eHealth\resources\views/usersEditAkunDokter.blade.php ENDPATH**/ ?>